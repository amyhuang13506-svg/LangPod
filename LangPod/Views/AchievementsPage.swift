...
struct AchievementsPage: View {
    ...
    private var badges: [Badge] {
        ...
        return [
            Badge(id: "first_play", icon: "🎧", name: String(localized: "初次播放"), condition: "听完第1集",
                  color1: "60A5FA", color2: "3B82F6", ringColor: "93C5FD", unlocked: totalEpisodes >= 1),
            Badge(id: "streak_3", icon: "🔥", name: String(localized: "三日坚持"), condition: "连续3天",
                  color1: "FB923C", color2: "EA580C", ringColor: "FDBA74", unlocked: streak >= 3),
            Badge(id: "streak_7", icon: "⚡", name: String(localized: "七日坚持"), condition: "连续7天",
                  color1: "FBBF24", color2: "D97706", ringColor: "FDE68A", unlocked: streak >= 7),
            Badge(id: "streak_30", icon: "👑", name: String(localized: "三十日"), condition: "连续30天",
                  color1: "A78BFA", color2: "7C3AED", ringColor: "C4B5FD", unlocked: streak >= 30),
            Badge(id: "words_10", icon: "📖", name: String(localized: "词汇新手"), condition: "保存10词",
                  color1: "6EE7B7", color2: "10B981", ringColor: "A7F3D0", unlocked: totalWords >= 10),
            Badge(id: "words_100", icon: "📚", name: String(localized: "词汇达人"), condition: "保存100词",
                  color1: "34D399", color2: "059669", ringColor: "6EE7B7", unlocked: totalWords >= 100),
            Badge(id: "match_50", icon: "🎯", name: String(localized: "配对高手"), condition: "配对50次",
                  color1: "F472B6", color2: "DB2777", ringColor: "FBCFE8", unlocked: matchCount >= 50),
            Badge(id: "sentence_20", icon: "✍️", name: String(localized: "造句达人"), condition: "造句20次",
                  color1: "818CF8", color2: "4F46E5", ringColor: "A5B4FC", unlocked: sentenceCount >= 20),
            Badge(id: "easy_done", icon: "🌱", name: String(localized: "初级毕业"), condition: "初级听完10集",
                  color1: "86EFAC", color2: "22C55E", ringColor: "BBF7D0", unlocked: totalEpisodes >= 10),
            Badge(id: "medium_done", icon: "🚀", name: String(localized: "中级毕业"), condition: "中级听完10集",
                  color1: "60A5FA", color2: "2563EB", ringColor: "93C5FD", unlocked: totalEpisodes >= 20),
            Badge(id: "hard_done", icon: "💎", name: String(localized: "高级毕业"), condition: "高级听完10集",
                  color1: "F87171", color2: "DC2626", ringColor: "FCA5A5", unlocked: totalEpisodes >= 30),
            Badge(id: "master", icon: "🏆", name: String(localized: "全能学者"), condition: "解锁全部",
