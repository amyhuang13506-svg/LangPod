...
enum Analytics {
    ...
    enum Event: String {
        ...
        case listeningTestStart = "listening_test_start"
        case listeningTestComplete = "listening_test_complete"
        case onboardingTestSkip = "onboarding_test_skip"
        case homeSegmentSwitch = "home_segment_switch"
        case rawSummaryView = "raw_summary_view"
        case rawSummaryCta = "raw_summary_cta"
        case rawQuizStart = "raw_quiz_start"
        case rawQuizComplete = "raw_quiz_complete"
